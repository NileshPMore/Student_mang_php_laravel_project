...
<x-app-layout>
                    ...
                    <form action="{{ route('savestudentdata') }}" method="POST">
                        ...
                        <div class="row p-1">
                           ...
                           <div class="row p-1">
                            ...
                            @error('classname')
                                <lable style="color:red;">Please select classname</lable>
                            @enderror
                        </div>
                         <div class="row p-1">
                            <div class="col-md-4">
                            ...
                            @error('add_date')
                                <lable style="color:red;">Please select addmission date</lable>
                            @enderror
                        </div>
                         ...
                         <div class="row p-1">
                            ...
                            <div class="col-md-4">
                                <input type="number" class="form-control" value="{{$yearly_fees}}" name="fees" id="fees" placeholder="Please enter fees" />
                            </div>
                            @error('fees')
                                <lable style="color:red;">Please enter yeasrly fees</lable>
                            @enderror
                        </div>
                        <div class="row p-1">
    ...
    <script>
        $(document).ready(function(){
            let teacher_id = @json($class_teacher_id);
            // let teacher_id = {!! json_encode($class_teacher_id) !!}
            $('#teachername').val(teacher_id);
        });
    </script>
</x-app-layout>